...
const BotProfilePage = ({ bot }) => {
    ...
    useEffect(()=>{
        ...
        const fetchBotData = async () => {
            try {
                const response = await fetch(`https://bot-build-server.vercel.app/api/user-info/`,{
                    method: 'GET',
                    headers: {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://bot-build-server.vercel.app/api/user-details-update/', {
                method: 'POST',
                headers: {
